...
- **cases/** — `Industry` (массив строк): индустрия клиента из WP-таксономии `case_industry`. 10 значений: DIY, FMCG, HoReCa, Ритейл, Бьюти, Детские товары, Искусство, Образование, Строительство, 18+.
